...
internal class AttachmentTest {
    ...
    fun `should be equal when the urls are identical`() {
        val attachment =  Attachment(url = "url", name = "attachment1")
        val other =  Attachment(url = "url", name = "attachment2")
    ...
    fun `should not be equal when the urls are different`() {
        val attachment =  Attachment(url = "url", name = "attachment", type = "motivation letter")
        val other =  Attachment(url = "url2", name = "attachment", type = "motivation letter")
